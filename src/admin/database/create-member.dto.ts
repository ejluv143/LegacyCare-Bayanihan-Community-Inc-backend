...
function optionalLowercaseTrim(value: unknown): unknown {
  if (typeof value !== 'string') {
    return value;
  }
...
function optionalUppercaseTrim(value: unknown): unknown {
  if (typeof value !== 'string') {
    return value;
  }
...
export class CreateMemberDto {
  ...
  @Transform(({ value }) => optionalLowercaseTrim(value))
  @IsOptional()
  @IsEmail(
    {},
    {
   ...
   */
  @Transform(({ value }) => optionalUppercaseTrim(value))
  @IsOptional()
  @IsString()
  @MinLength(1)
  @MaxLength(40)

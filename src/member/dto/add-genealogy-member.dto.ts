...
function optionalLowercaseTrimValue(
  value: unknown,
): unknown {
  if (typeof value !== "string") {
    return value;
...
export class AddGenealogyMemberDto {
  ...
  @Transform(({ value }) =>
    optionalLowercaseTrimValue(value),
  )
  @IsOptional()
  @IsEmail(
    {},
